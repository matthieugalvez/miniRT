...
/*   Updated: 2025/02/02 13:33:23 by achantra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	debug_env(t_env *env)
{
	...
	if (env->camera)
		printf("camera: %f,%f,%f, %f,%f,%f, %f\n", env->camera->coord->x,
			env->camera->coord->y, env->camera->coord->z,
	...
	if (env->elem)
	{
		...
		{
			if (buf->id == CYLINDER)
				printf("cylindre: %f,%f,%f %f,%f,%f %f %f %d,%d,%d\n",
				...
				printf("plane: %f,%f,%f %f,%f,%f %d,%d,%d\n", buf->coord->x,
					buf->coord->y, buf->coord->z, buf->vector->x,
