...
static void debug_env_figure(t_element *figure) {
    while (figure) {
        if (figure->id == SPHERE)
            ...
            printf("pl %.2f,%.2f,%.2f %.2f,%.2f,%.2f %d,%d,%d", figure->coord.x,
                   figure->coord.y, figure->coord.z, figure->vector.x,
                   figure->vector.y, figure->vector.z, figure->color.r,
            ...
            printf("cy %.2f,%.2f,%.2f %.2f,%.2f,%.2f %.2f %.2f %d,%d,%d",
                   ...
                   figure->diameter, figure->height, figure->color.r,
                   figure->color.g, figure->color.b);
        ...
        if (figure->color_cmpt == 2)
            printf(" %d,%d,%d", figure->colorbis.r, figure->colorbis.g,
                   figure->colorbis.b);
        printf("\n");
        figure = figure->next;
    }
...
static void debug_env_light(t_light *light) {
    while (light) {
        printf("L %.2f,%.2f,%.2f %.2f %d,%d,%d\n", light->coord.x,
               light->coord.y, light->coord.z, light->bright, light->color.r,
...
void debug_env(t_env *env) {
    ...
    printf("C %.2f,%.2f,%.2f, %.2f,%.2f,%.2f, %.2f\n", env->camera.coord.x,
           env->camera.coord.y, env->camera.coord.z, env->camera.dir.x,
           env->camera.dir.y, env->camera.dir.z, env->camera.fov);
    if (env->figure)
