...
/*   Updated: 2025/09/11 19:26:28 by mgalvez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static double intersect_disk(t_element *cy, t_ray *ray, t_coordinates *c_disk,
                             double cos_angle) {
...
static void intersect_pipe(t_element *cy, t_ray *ray, t_coordinates av,
                           t_coordinates bv) {
    double a;
    double b;
    double c;
