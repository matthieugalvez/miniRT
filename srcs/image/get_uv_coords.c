...
static void uv_pl(t_hitpoint *hitpoint, t_element *figure, double *uv_coords) {
...
static void uv_sp(t_hitpoint *hitpoint, t_element *figure, double *uv_coords) {
...
void get_uv_coords(t_hitpoint *hitpoint, t_element *figure, double *uv_coords) {
    if (figure->id == SPHERE)
