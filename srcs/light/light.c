...
/*   Updated: 2025/03/01 18:04:36 by mgalvez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		double cos_angle)
{
	...
	applied_diffuse.r = figure_color->r * (255 * light->bright * 0.9);
	applied_diffuse.g = figure_color->g * (255 * light->bright * 0.9);
	applied_diffuse.b = figure_color->b * (255 * light->bright * 0.9);
