...
IMAGE_SRCS	= cam_ray_tracing.c check_color.c get_uv_coords.c find_pixel.c \
  			  image_utils.c
INIT_SRCS	= init_ambient.c init_camera.c init_elements.c init_env.c \
  			  ...
  			  init_utils2.c
LIGHT_SRCS	= light.c compute_light_source.c
...
MLX_SRCS	= key_funcs.c camera_key_funcs.c figures_key_funcs.c \
  			  ...
  			  mlx_utils.c
PARSE_SRCS	= parsing.c parse_color.c parse_coordinates.c parse_number.c \
			  parse_xpm_file.c
